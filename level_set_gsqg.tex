...
%    All constants $C_{\alpha}$ in this proof depend only on $\alpha$ and
    ...
    \begin{align*}
        G_{1} &=
        \int_{\ell_{\eps}^{t,\lambda}\bbT}\int_{\mathcal{L}}\int_{\bbR^{2}}
        \kappa_{\eps}^{t,\lambda}(s)\mathbf{N}_{\eps}^{t,\lambda}(s) \cdot
        D^{2}(\nabla^{\perp}K_{\eps})(z_{\eps}^{t,\lambda}(s) - y)
        (\mathbf{T}_{\eps}^{t,\lambda}(s), \mathbf{T}_{\eps}^{t,\lambda}(s))
        \\&\qquad\qquad\qquad\quad
        \mathbbm{1}_{\Phi_{\eps}^{t}(\Omega^{\lambda'})}(y)
        \,dy\,d\theta(\lambda')\,ds\\
        &= \int_{\mathcal{L}}\int_{\ell_{\eps}^{t,\lambda}\bbT}\int_{\bbR^{2}}
        \kappa_{\eps}^{t,\lambda}(s)\mathbf{N}_{\eps}^{t,\lambda}(s) \cdot
        D^{2}(\nabla^{\perp}K_{\eps})(z_{\eps}^{t,\lambda}(s) - y)
        (\mathbf{T}_{\eps}^{t,\lambda}(s), \mathbf{T}_{\eps}^{t,\lambda}(s))
        \\&\qquad\qquad\qquad\quad
    ...
    of the right-hand side in the last equality; we only know the measurability
    with respect to $\lambda'$ of the inner integral.)
    From
    \[
